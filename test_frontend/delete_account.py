...
def test_R2T3(capsys):
    ...
    helper(
        ...
        expected_tail_of_terminal_output=[
            'Account not exist! Enter a existed account to withdraw!', 'Enter your account number:'
        ],
        expected_output_transactions=['EOS 0000000 000 0000000 ***']
    )
...
def test_R2T4(capsys):
    ...
    helper(
        ...
        expected_tail_of_terminal_output=[
            'Enter your account name:Enter your account number:Account number not exist', 'Enter your account number:'
        ],
        expected_output_transactions=['EOS 0000000 000 0000000 ***']
    )
